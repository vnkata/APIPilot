...
export const constraintFacets: ConstraintFacetsResponse = {
  ...
  decision_source: [],
  has_manual_decision: [{ key: 'false', count: 1 }],
  manual_decision: [],
  metadata: { combined_source: 'artifact', warnings: [] },
...
export const combinationFacets: CombinationFacetsResponse = {
  ...
  review_state: [{ key: 'PENDING_REVIEW', count: 1 }],
...
export const combinationReview: CombinationReviewResponse = {
  cases: [
    {
      case_id: 'ce-case-1',
      case_state: 'DRAFT',
      rationale: 'Draft probes the dynamic side of the relation.',
      expected_observation: 'Static constraint holds while dynamic constraint fails.',
      generation_id: 'ceg-fixture',
...
export const constraintResearchSummary: ConstraintResearchSummaryResponse = {
  evidence_artifact: 'counter_example_case_results.jsonl',
  evidence_case_count: 2,
  invalid_runtime_counts: { property_missing: 1 },
  label_artifact: 'constraint_pair_labels.csv',
  label_counts: {
    combined_label: { UNSURE: 1 },
    dynamic_label: { TP: 1 },
    static_label: { UNSURE: 1 },
  },
  metric_excluded_counts: { UNKNOWN: 1 },
  pair_count: 1,
  planner_status_counts: { generated: 1, fallback: 1 },
  relation_counts: { STATIC_STRONGER: 1 },
  run_name: 'Run A',
  runtime_recommendation_counts: { SUPPORT_STATIC: 1 },
  source_metrics: {
    combined_label: { evaluated: 0, f1: null, fp: 0, precision: null, recall: null, tp: 0, unsure: 1 },
    dynamic_label: { evaluated: 1, f1: null, fp: 0, precision: 1, recall: null, tp: 1, unsure: 0 },
    static_label: { evaluated: 0, f1: null, fp: 0, precision: null, recall: null, tp: 0, unsure: 1 },
  },
  status_counts: { UNRESOLVED: 1 },
}

export const constraintResearchEntries: ConstraintResearchEntryPageResponse = {
  items: [
    {
      ...
      notes: 'Needs researcher confirmation.',
      operation_id: 'get-/items',
      orphaned: false,
      property_path: 'input.limit',
...
export const constraintResearchDetail: ConstraintResearchDetailResponse = {
  ...constraintResearchEntries.items[0],
  operation_spec_excerpt: {
    method: 'get',
  ...
  evidence_cases: [
    {
      ...
      combination_id: 'cmb-static-stronger',
      execution_metadata: { elapsed_ms: 42, method: 'GET' },
      invalid_detail: '',
      invalid_reason: '',
      pair_id: 'cmb-static-stronger',
      planner_error_kind: '',
      planner_status: 'generated',
      request_summary: { method: 'GET', path: '/items', query: { limit: 51 } },
      response_summary: { property_value: 51, status_code: 200 },
      runtime_recommendation: 'SUPPORT_STATIC',
      runtime_verdict: 'STATIC_WIN',
      weak_evidence: false,
    },
    {
      case_id: 'research-case-2',
      combination_id: 'cmb-static-stronger',
      execution_metadata: { elapsed_ms: 12, method: 'GET' },
      invalid_detail: 'Response did not include the target property.',
      invalid_reason: 'property_missing',
      pair_id: 'cmb-static-stronger',
      planner_error_kind: 'planner_parse_error',
      planner_status: 'fallback',
      request_summary: { method: 'GET', path: '/items', query: { limit: 0 } },
      response_summary: { status_code: 200 },
      runtime_recommendation: 'INCONCLUSIVE',
      runtime_verdict: 'INVALID',
      weak_evidence: true,
    },
  ],
}
