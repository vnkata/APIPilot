...
def list_operation_explorer_entries(
    ...
    has_constraints: bool | None = Query(default=None, description="Filter by constraint availability."),
    has_invariants: bool | None = Query(default=None, description="Filter by invariant availability."),
    ...
    sort_by: str | None = Query(
        default=None,
        description="Allowed values: operation_key, operation_id, http_method, path_template, constraint_count, invariant_count, graph_in_degree, graph_out_degree, test_case_count.",
    ),
    sort_order: SortOrder = Query(default=SortOrder.ASC),
    group_by: str | None = Query(
        default=None,
        description="Allowed values: http_method, has_request_body, has_constraints, has_invariants, has_graph_edges, has_failures.",
    ),
