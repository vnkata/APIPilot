...
from api_testing.constraint.ir.models import ConditionModel
...
class CELEvaluator:
    ...
    def _evaluate_cel(self, expr: str, context: Dict[str, Any]) -> bool:
    ...
    def _evaluate_python(self, expr: str, context: Dict[str, Any]) -> bool:
