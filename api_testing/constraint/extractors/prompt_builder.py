...
from api_testing.constraint.primitives.registry_loader import get_registry
from api_testing.constraint.primitives.registry_models import PredicateMetadata
...
class PredicatePromptBuilder:
    ...
    def _format_args_schema(self, properties: Dict) -> str:
